...
def _e(
    ...
    **attributes,
    ...
    return LexEntry(
        canonical, entity_type, patterns or (canonical,), description, attributes or None
    )
...
CELESTIAL: list[LexEntry] = [
    _e(
        "Sun",
        EntityType.ASTRONOMICAL_OBJECT,
        "sun",
        "sol",
        "helios",
        "shamash",
    ...
    _e(
        ...
        "brihaspati",
        "guru",
        description="Jupiter, royal star of Babylonian astrology.",
        body="Jupiter",
    ),
    _e(
        "Saturn",
...
ZODIAC: list[LexEntry] = [
    ...
    for name, aliases in [
        ...
        ("Capricorn", ("capricornus", "the goat")),
        ("Aquarius", ("the water bearer",)),
        ("Pisces", ("the fishes", "the fish")),
    ]
]
...
PHENOMENA: list[LexEntry] = [
    _e(
        ...
        "solar eclipse",
        "eclipse of the sun",
        "sun (?:was |shall be |is )?darkened",
        "sun (?:became|becometh|shall be) black",
        "darkness (?:over|upon) the (?:whole )?land",
        "the sun (?:hid|withdrew) (?:his|its) light",
        description="Reference to the Sun being obscured.",
    ...
    _e(
        ...
        "eclipse of the moon",
        "moon (?:in)?to blood",
        "moon (?:shall be |was |became )?(?:turned )?(?:as |into )?blood",
        "blood moon",
        "moon (?:was |shall be )?darkened",
        description="Reference to the Moon reddening or darkening.",
    ...
    _e(
        ...
        "bearded star",
        "star with a tail",
        "sword.{0,12}(?:in|over) the (?:sky|heaven)",
        description="A comet or comet-like apparition.",
        event_type="comet",
    ),
    _e(
        "Meteor",
        EntityType.METEOR_SHOWER,
        "meteor",
        "shooting star",
        "falling star",
        "stars (?:shall )?fall",
        ...
        "fire from heaven",
        description="Meteors or a meteor storm.",
        event_type="meteor_shower",
    ),
    _e(
        "New moon",
        EntityType.MOON_PHASE,
        "new moon",
        "rosh chodesh",
        "first crescent",
        "new moon festival",
...
CALENDARS: list[LexEntry] = [
    ...
    _e(
        ...
        "stem[- ]branch",
        "lunar new year",
        calendar_key="chinese_sexagenary",
    ),
    _e(
        "Persian calendar",
        EntityType.CALENDAR,
...
SACRED_NUMBERS: dict[str, dict] = {
    ...
    "12": {
        "significance": "Twelve tribes, twelve apostles, twelve zodiac signs, twelve months. "
    ...
    "153": {
        "significance": "The fish of John 21; a triangular number that attracted much "
        "patristic numerology."
    },
    "216": {"significance": "6³; associated with Platonic and Pythagorean number mysticism."},
    "360": {
        "significance": "The idealised year of many ancient calendars, and degrees of a circle."
    },
    "432": {"significance": "Base of the Hindu yuga figures (432,000 years for the Kali Yuga)."},
    "666": {
        "significance": "The number of the beast, Revelation 13:18. Note the well-attested "
        "616 variant in Papyrus 115."
    },
    "616": {"significance": "Variant of the beast's number in Papyrus 115 and Codex Ephraemi."},
    "1260": {
        "significance": "Days in Revelation 11–12; equals 42 months of 30 days, or "
    ...
    "5778": {
        "significance": "A Hebrew calendar year (2017–2018 CE) that attracted attention "
