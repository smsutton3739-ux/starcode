...
METEOR_SHOWERS: list[MeteorShower] = [
    MeteorShower(
        ...
        "(196256) 2003 EH1",
        "Boötes",
        "Sharp peak, only a few hours wide.",
    ),
    MeteorShower(
        "lyr",
        "Lyrids",
    ...
    MeteorShower(
        ...
        "169P/NEAT",
        "Capricornus",
        "Low rate but noted for bright fireballs.",
    ),
    MeteorShower(
        "sda",
    ...
    MeteorShower(
        ...
        "109P/Swift–Tuttle",
        "Perseus",
        "Recorded in Chinese annals from 36 CE; called the 'Tears of "
    ...
    MeteorShower(
        ...
        "Draco",
        "Highly variable; produced storms in 1933 and 1946.",
    ),
    MeteorShower(
        "ori",
        "Orionids",
    ...
    MeteorShower(
        ...
        "(3200) Phaethon",
        "Gemini",
        "Now the strongest annual shower; only recognised in the 1860s, "
...
COMET_APPARITIONS: list[CometRecord] = [
    CometRecord(
        ...
        "Halley's Comet",
        -239,
        "Perihelion 25 May 240 BCE",
        "both",
        ["Shiji (Records of the Grand Historian), Chinese observation"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/-163 U1",
        "Halley's Comet",
        -163,
        "Perihelion 12 November 164 BCE",
        "both",
        ["Babylonian astronomical diaries BM 41462"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/-86 Q1",
        "Halley's Comet",
        -86,
        "Perihelion 6 August 87 BCE",
        "both",
        ["Babylonian tablet BM 41628", "Chinese records, Han shu"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/-11 Q1",
    ...
    CometRecord(
        ...
        "Halley's Comet",
        530,
        "Perihelion 27 September 530 CE",
        "both",
        ["Chinese and Byzantine records"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/607 H1",
    ...
    CometRecord(
        ...
        "Halley's Comet",
        912,
        "Perihelion 18 July 912 CE",
        "both",
        ["Chinese, Japanese and European records"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/989 N1",
    ...
    CometRecord(
        ...
        "Halley's Comet",
        1145,
        "Perihelion 18 April 1145",
        "both",
        ["Eadwine Psalter drawing"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/1222 R1",
        "Halley's Comet",
        1222,
        "Perihelion 28 September 1222",
        "both",
        ["Japanese, Chinese and Korean records"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/1301 R1",
    ...
    CometRecord(
        ...
        "Halley's Comet",
        1456,
        "Perihelion 9 June 1456",
        "both",
        ["Observed during the Ottoman siege of Belgrade", "Observed by Paolo dal Pozzo Toscanelli"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/1531 P1",
        "Halley's Comet",
        1531,
        "Perihelion 26 August 1531",
        "both",
        ["Observed by Peter Apian"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/1607 S1",
    ...
    CometRecord(
        ...
        "Halley's Comet",
        1682,
        "Perihelion 15 September 1682",
        "both",
        ["Observed by Edmond Halley, who predicted its return"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/1758 Y1",
        "Halley's Comet",
        1759,
        "Perihelion 13 March 1759",
        "both",
        ["First predicted return of a comet"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/1835 P1",
    ...
    CometRecord(
        ...
        "Halley's Comet",
        1910,
        "Perihelion 20 April 1910",
        "both",
        ["Earth passed through the tail on 19 May 1910"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "1P/1982 U1",
        "Halley's Comet",
        1986,
        "Perihelion 9 February 1986",
        "both",
        ["Giotto spacecraft encounter"],
        YEOMANS_REFERENCE,
    ),
    CometRecord(
        "C/-43 K1",
    ...
    CometRecord(
        ...
        "historical_record",
        ["Chinese records", "Astronomer's Life of Louis the Pious"],
    ),
    CometRecord(
        "C/1577 V1",
        "Great Comet of 1577",
    ...
    CometRecord(
        ...
        "Great Comet of 1811",
        1811,
        "Visible to the naked eye for about 260 days",
        "both",
    ...
    CometRecord(
        ...
        1843,
        "A Kreutz sungrazer with an exceptionally long tail",
        "both",
        ["Widely observed; contributed to Millerite expectations in the USA"],
    ),
    CometRecord(
        "C/1858 L1", "Comet Donati", 1858, "One of the most photographed of its era", "both", []
    ),
]
...
HISTORICAL_SUPERNOVAE = [
    ...
    },
    {
        ...
        "record": "Book of Jin",
        "modern_remnant": "G11.2-0.3 (debated)",
        "evidence": "historical_record",
    },
    {
        "designation": "SN 1006",
    ...
    },
    {
        ...
        "record": "Chinese and Japanese records",
        "modern_remnant": "Pa 30 (proposed)",
        "evidence": "historical_record",
    },
    {
        "designation": "SN 1572",
    ...
    },
    {
        ...
        "record": "Johannes Kepler, De stella nova",
        "modern_remnant": "Kepler's SNR",
        "evidence": "both",
    },
]
...
ECLIPTIC_CONSTELLATIONS = [
    ...
    (174.0, 218.0, "Virgo"),
    (218.0, 241.0, "Libra"),
    (241.0, 248.0, "Scorpius"),
    (248.0, 266.0, "Ophiuchus"),
    (266.0, 300.0, "Sagittarius"),
    (300.0, 327.7, "Capricornus"),
    (327.7, 351.6, "Aquarius"),
    (351.6, 388.7, "Pisces"),
]
