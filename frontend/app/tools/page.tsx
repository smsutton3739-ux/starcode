  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      {configured ? (
          ...
          {WIDGETS.map(({ tool, heading, minHeight, blurb }) => (
            <section key={tool} className="mt-10">
              ...
              <iframe
                ...
                className="mt-4 block w-full rounded-lg border border-slate-200 dark:border-slate-800"
                style={{ minHeight }}
              />
            </section>
          ))}
        ...
        <div className="mt-10 rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-400">
